...
logo_canvas = tk.Canvas( root,  bg = "blue", highlightthickness = 0, height = 58, width = 590 )
...
tab_space = tk.Canvas( background_space, bg = 'red', highlightthickness = 0, width = 400, height = 600, scrollregion=(0, 0, 2000, 780))
