...
#python temp.py /Users/miyamoto/Projects/sample/sample/python_tutorial/data 3 --img_size 256 --do_plot
...
def build_HDF5(jpeg_dir, nb_channels, size=256):
    ...
    with h5py.File(hdf5_file, "w") as hfw:
        ...
        for dset_type in ["test"]:
            ...
            print(list_img)
            output = parmap.map(format_image, list_img
                , size, nb_channels, parallel=False)
...
def check_HDF5(jpeg_dir, nb_channels):
    ...
    with h5py.File(hdf5_file, "r") as hf:
        data_full = hf["test_data_full"]
        data_sketch = hf["test_data_sketch"]
